...
#     'sortByR2': 'featured',
#     '_sp_ses.9084': '*',
#     'ntfPopupSuppressionCount': '3',
#     '_sp_id.9084': '9f0c6410-73c0-4d20-a072-396261b3ba0d.1562070789.1.1562070806.1562070789.dd03fe67-3ba8-4a48-857d-adefb4c54a0a',
#     'SSP_AB_StyleFinder_20160425': 'Test',
#     'SSP_AB_StyleFinderPhase_20160425': 'Phase2',
#     'lastRskxRun': '1562070805598',
...
headers = {
    ...
    'Referer': 'https://www.revolve.com/content/products/editorial?prettyPath=/r/Editorials.jsp&listname=Dresses%20by%20Price%20JUN24&cplid=26007&hsclk10082=1&navsrc=hp_5_f&hspos=5',
...
# response = requests.get('https://www.revolve.com/jackets-coats/br/e4012a/', headers=headers, params=params, cookies=cookies)

#NB. Original query string below. It seems impossible to parse and
#reproduce query strings 100% accurately so the one below is given
#in case the reproduced version is not "correct".
# response = requests.get('https://www.revolve.com/jackets-coats/br/e4012a/?navsrc=subclothing', headers=headers, cookies=cookies)
response = requests.get('https://www.revolve.com/jackets-coats/br/e4012a/?navsrc=subclothing', headers=headers)
print(response.content)
html_dump = open("revolve_listing.html", "w+")
